...
$(document).ready(function () {
    ...
    $input.on('keydown', function (e) {
        ...
        setTimeout(function () {
            messenger.recieve('Hi :), saw your profile on MM, I felt like I knw u before n we also got few mutual frnds as well, so felt like pinging, hoping u dnt mind as u look to a hv a modern outloook :)');
        }, 500);

        setTimeout(function () {
            messenger.recieve('This is not a marriage proposal btw  ');
        }, 1000);

        setTimeout(function () {
            messenger.send('Yes We too saw your profile . But I haven\'t felt like I have seen you before :)');
        }, 1500);
